...
struct Lesson: Identifiable {
    ...
    static let all: [Lesson] = [
        Lesson(
            ...
            question: "세 번 누르는 동안 손이 어떻게 움직였나요? 불편하거나 이상하다고 느낀 지점이 있었나요?",
            placeholder: "예: 매번 손을 위로 뻗어야 했다. 두 번째부터는 기기를 고쳐 쥐게 됐다.",
        ...
        Lesson(
            ...
            task: "노트를 **하나 지워** 보세요. 그다음 새 노트를 만들려면 어디를 눌러야 할지도 찾아보세요.",
            question: "지우기까지 몇 단계를 거쳤나요? 확인 절차가 있었나요? 실수로 누를 뻔한 순간은요?",
            placeholder: "예: 한 번 누르니 바로 사라졌다. 엄지가 늘 지나가는 자리라 아찔했다.",
        ...
        Lesson(
            ...
            task: "오른쪽 위 버튼들로 **정렬을 한 번, 편집을 한 번** 눌러보세요.",
            question: "그 버튼들이 한 덩어리로 보였나요? 누르는 동안 아찔하거나 망설인 순간이 있었나요?",
            placeholder: "예: 세 개가 붙어 있어 아이콘을 하나씩 확인해야 했다. 옆에 삭제가 있어 조심스러웠다.",
        ...
        Lesson(
            ...
            task: "폴더를 **업무 → 개인**으로 바꿔보세요.",
            question: "폴더를 바꾸는 곳을 어디서 찾았나요? 제목과 그 버튼이 서로 이어져 있다고 느꼈나요?",
            placeholder: "예: 제목을 먼저 눌러봤는데 안 됐다. 왼쪽 위 버튼을 찾는 데 시간이 걸렸다.",
        ...
        Lesson(
            ...
            task: "**검색으로 운송장을 찾아** 보세요. 그다음 검색을 비우고 목록으로 돌아와 보세요.",
            question: "검색을 열고 닫는 동안 손이 어디까지 올라갔나요? 검색을 안 쓰는 동안 그 자리는 무엇을 하고 있었나요?",
            placeholder: "예: 화면 위쪽까지 손을 뻗어야 했다. 안 쓸 때도 한 줄을 계속 차지하고 있었다.",
        ...
        Lesson(
            ...
            task: "이 화면은 **영어(en_US) 기기**입니다. 목록의 **수정 시각**을 하나씩 읽어보세요.",
            question: "표기에서 어색한 데가 있었나요? 이 기기를 쓰는 사람에게 저 시각이 어떻게 읽힐까요?",
            placeholder: "예: 영어 기기인데 날짜만 한국어 표기였다. 영어 사용자라면 못 읽을 것 같다.",
        ...
        Lesson(
            ...
            task: "**운송장 번호 노트를 열고**, 그 번호를 다른 앱에 옮긴다고 생각하고 복사해 보세요.",
            question: "복사가 됐나요? 안 됐다면, 실제 상황에서 사용자는 무엇을 하게 될까요?",
            placeholder: "예: 길게 눌러도 아무 일도 없었다. 결국 눈으로 보고 손으로 옮겨 적어야 할 것 같다.",
        ...
        Lesson(
            ...
            question: "저장을 어디서 찾았나요? 한 번 저장하는 데 몇 번의 동작이 필요했나요?",
            placeholder: "예: 툴바에 없어서 ⋯ 를 열었다. 자주 쓰는 건데 매번 두 번씩 눌러야 했다.",
        ...
        Lesson(
            ...
            task: "사진 격자를 **천천히 스크롤**하면서 상단의 선택·공유 버튼을 계속 읽어보세요.",
            question: "버튼이 잘 안 보이는 순간이 있었나요? 어떤 사진이 지나갈 때였나요?",
            placeholder: "예: 어두운 사진에선 괜찮다가 흰 사진이 올라오니 글자가 사라졌다.",
        ...
        Lesson(
            ...
            task: "이 화면은 **접근성 큰 글씨** 상태입니다. 배송지와 주문번호를 **소리 내어 읽어** 보세요.",
        ...
        Lesson(
            ...
            question: "탭을 눌렀는데 어디로 갔나요? 내가 뭘 잘못 눌렀나 싶은 순간이 있었나요?",
            placeholder: "예: 시트만 뜨고 탭은 홈으로 돌아와 있었다. 한 번 더 눌러봤다.",
        ...
        Lesson(
            ...
            task: "이 메모를 **완료(저장)** 해보세요. 세 번 반복해 보세요.",
        ...
        Lesson(
            ...
            task: "**새 글쓰기를 세 번** 눌러보세요. 사이사이 목록도 스크롤해 보세요.",
            question: "혜택 배너를 누른 적이 있나요? 눌렀다면 그건 누르려던 것이었나요?",
            placeholder: "예: 스크롤하다 엄지가 배너에 닿았다. 두 버튼이 붙어 있어 새 글쓰기가 좁게 느껴졌다.",
        ...
        Lesson(
            ...
            task: "이 화면은 **접근성 큰 글씨** 상태입니다. 상단 액션을 하나씩 눌러보고 제목도 읽어보세요.",
        ...
        Lesson(
            ...
            question: "검색창을 다시 꺼내려고 무엇을 했나요? 한 손으로 하기에 어땠나요?",
        ...
        Lesson(
            ...
            task: "결제 내역의 **금액을 하나씩 소리 내어 읽어** 보세요.",
        ...
        Lesson(
            ...
            task: "**가장 오른쪽 탭**을 한 손으로 눌러보세요. 라벨도 읽어보세요.",
            question: "누르려던 탭이 눌렸나요? 라벨은 끝까지 보였나요?",
            placeholder: "예: 라벨이 잘려 있었고, 엄지로 누르니 옆 탭이 눌렸다.",
        ...
        Lesson(
            ...
            task: "카드 번호를 **몇 자 입력한 뒤** 쿠폰함 탭에 갔다가 돌아와 보세요.",
            question: "돌아왔을 때 입력한 내용은 어떻게 됐나요? 그때 무엇을 하고 싶어졌나요?",
            placeholder: "예: 카드 번호가 비어 있었다. 다시 입력하기 싫어서 그냥 나가고 싶었다.",
        ...
        Lesson(
            ...
            task: "파일 하나의 **⋯ 메뉴를 열고 이름 변경**을 눌러보세요. 메뉴를 읽지 말고 빠르게 눌러보세요.",
